...
print(f"Preparing your {sugar} teaspoons of sugar, {coffee} shots of coffee, and {milk} ounces of milk...")# Print a message confirming the order.
...
if sugar > 2:
    print(f"Thank you for your purchase! Enjoy your really sweet cup of coffee!")# Check if the user ordered a sweet coffee.
